...
import com.example.kt.shudaapp.AdapterClass.ShaheedPakagePotraitAdapter;
...
public class ShaeedPakagePotraitActivity extends AppCompatActivity {
    private RecyclerView mRecyclerView;
    private ShaheedPakageModel shaheedPakageModel;
    private List<ShaheedPakageModel.Val> list = new ArrayList<>();
    private ShaheedPakagePotraitAdapter shaheedPakageAdapter;
            ...
            public void onResponse(Call<ShaheedPakageModel> call, Response<ShaheedPakageModel> response) {
                if (response.isSuccessful()){
                    if (response.body().getSuccess() == 1){
                        ...
                        shaheedPakageAdapter = new ShaheedPakagePotraitAdapter(ShaeedPakagePotraitActivity.this, list);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menuInflater.inflate(R.menu.pakage_potrait_menu, menu);
        return true;
    }
    @Override
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            case R.id.landscape_mode:
                startActivity(new Intent(ShaeedPakagePotraitActivity.this, ShaeedPakageLandscapeActivity.class));
                finish();
                break;
        }
